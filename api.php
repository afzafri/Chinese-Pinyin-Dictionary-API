...
echo "
- Usage: http://".$_SERVER['SERVER_NAME'].$_SERVER['REQUEST_URI']."?define=TEXT , where 'TEXT' is your text to search (English, Pinyin or Chinese characters)\n
- By default, the API will fetch the first 50 records. To fetch all records, append '&records=NUMBER' to the endpoint , where 'NUMBER' is your number of records to display\n
  - Ex: http://".$_SERVER['SERVER_NAME'].$_SERVER['REQUEST_URI']."?define=TEXT&records=100
";
}
